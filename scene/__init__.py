...
# https://github.com/NVlabs/InstantSplat/blob/main/scene/__init__.py
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, opt=None, shuffle=True, resolution_scales=[1.0]):
        ...
        if self.loaded_iter:
            ...
            if args.init_scale_from_view_depth:
                scale_gaussian = compute_scale_gaussian_by_project_pair_pcd(scene_info.point_cloud.points,np.linalg.inv(scene_info.train_poses),[[fov2focal(i.FovX, i.width),fov2focal(i.FovY,i.height)]for i in scene_info.train_cameras],)
