    ...
    def __init__(
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            scene_info = sceneLoadTypeCallbacks["Colmap"](
                args.source_path, args.images, args.eval, args
            )
        ...
        if self.loaded_iter:
            ...
            if args.init_scale_from_view_depth:
                scale_gaussian = compute_scale_gaussian_by_project_pair_pcd(
                    ...
                    [
                        [fov2focal(i.FovX, i.width), fov2focal(i.FovY, i.height)]
                        for i in scene_info.train_cameras
                    ],
                )
            self.gaussians.create_from_pcd(
                scene_info.point_cloud, self.cameras_extent, scale_gaussian
            )
